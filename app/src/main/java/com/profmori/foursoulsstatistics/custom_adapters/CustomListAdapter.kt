...
class CustomListAdapter(private var cardList: Array<String>, private val font: Typeface) : RecyclerView.Adapter<CustomListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val contactView = inflater.inflate(R.layout.custom_entry, parent, false)
