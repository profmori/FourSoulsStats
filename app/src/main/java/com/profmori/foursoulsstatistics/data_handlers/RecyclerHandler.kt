...
class RecyclerHandler {
    companion object {
        ...
        fun updateView(
            ...
            val playerAdaptor =
                DropDownAdapter(playerEntry.context, pDropDown, playerHandler.fonts["body"]!!)
            ...
            val charAdapter =
                DropDownAdapter(charEntry.context, cDropDown, playerHandler.fonts["body"]!!)
            ...
            if (playerHandler.charName == "eden") {
                ...
                val eternalAdapter =
                    DropDownAdapter(charEntry.context, itemList, playerHandler.fonts["body"]!!)
